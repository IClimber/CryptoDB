...
namespace CryptoDataBase.CryptoContainer.Models
{
    ...
    public class Header
    {
        ...
        public byte[] ToBufferFirstBlock()
        {
            ...
            result[16] = (byte)(Convert.ToByte(!Exists) * 128 + (int)RandomHelper.Random(128));
        ...
        public byte[] ToBufferEncryptBlock()
        {
            ...
            RandomHelper.GetBytes(result);
            Buffer.BlockCopy(BitConverter.GetBytes(_infSize), 0, result, 13, 2);
            Buffer.BlockCopy(BitConverter.GetBytes((byte)ElementType * 128 + (int)RandomHelper.Random(128)), 0, result, 15, 1);
        ...
        public void Delete()
        {
            ...
            if (_wasWroteInFile)
            {
                _repository.WriteByte((long)_startPos + 16, (byte)(Convert.ToByte(!_exists) * 128 + (int)RandomHelper.Random(128)));
            }
        }
